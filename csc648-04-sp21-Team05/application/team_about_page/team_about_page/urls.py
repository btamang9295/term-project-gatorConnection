...
urlpatterns = [
    ...
    path('alec', views.about_team_member, name='team_members_alec'),
    path('angelo', views.about_team_member, name='team_members_angelo'),
    path('benjamin', views.about_team_member, name='team_members_benjamin'),
    ...
    path('link_request_alec', views.InsertrecordAlec, name = 'link_request_alec'),
    path('link_request_angelo', views.InsertrecordAngelo, name='link_request_angelo')
]
